    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-100 to-gray-200 flex items-center justify-center p-4">
      <Card className="w-full max-w-4xl shadow-xl">
        <CardHeader className="text-center">
          <CardTitle className="text-3xl font-bold">Define Your Ideal Customer Profile (ICP)</CardTitle>
          <CardDescription className="text-lg">Complete the form below to create a detailed profile of your ideal customer.</CardDescription>
        </CardHeader>
        <ScrollArea className="h-[calc(100vh-200px)] px-4 py-2">
          <form onSubmit={handleSubmit}>
            <CardContent className="space-y-8">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Input id="industry" name="industry" value={formData.industry} onChange={handleInputChange} placeholder="e.g., Technology, Healthcare" />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="location">Location</Label>
                    <Input id="location" name="location" value={formData.location} onChange={handleInputChange} placeholder="e.g., North America, Europe" />
                  </div>
                </div>
                <div className="space-y-2">
                  <Label htmlFor="annualRevenue">Annual Revenue</Label>
                  <Select name="annualRevenue" onValueChange={handleSelectChange('annualRevenue')}>
                    <SelectTrigger>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex space-x-2">
                    ...
                    />
                    <Button type="button" onClick={handleAddPainPoint} size="icon">
                  ...
                  <ul className="mt-2 space-y-2">
                    {formData.painPoints.map((point, index) => (
                      <li key={index} className="flex items-center justify-between bg-muted p-2 rounded-md">
                        <span>{point}</span>
                        <Button type="button" onClick={() => handleRemovePainPoint(index)} variant="ghost" size="sm">
                          <X className="h-4 w-4" />
                ...
                <div className="space-y-2">
                  ...
                  <ul className="mt-2 space-y-2">
                    {formData.goals.map((goal, index) => (
                      <li key={index} className="flex items-center justify-between bg-muted p-2 rounded-md">
                        <span>{goal}</span>
                        <Button type="button" onClick={() => handleRemoveGoal(index)} variant="ghost" size="sm">
                          <X className="h-4 w-4" />
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="decisionMakers" name="decisionMakers" value={formData.decisionMakers} onChange={handleInputChange} placeholder="e.g., CTO, VP of Marketing" />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="purchaseProcess">Typical Purchase Process</Label>
                  <Textarea id="purchaseProcess" name="purchaseProcess" value={formData.purchaseProcess} onChange={handleInputChange} placeholder="Describe the steps in their buying process" className="min-h-[100px]" />
                </div>
              </div>

              <div className="space-y-4">
                <h3 className="text-xl font-semibold">Budget and Purchasing Habits</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <Label htmlFor="budget">Typical Budget</Label>
                    <Input id="budget" name="budget" value={formData.budget} onChange={handleInputChange} placeholder="e.g., $10,000 - $50,000" />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="timeframe">Purchase Timeframe</Label>
                    <Select name="timeframe" onValueChange={handleSelectChange('timeframe')}>
                      <SelectTrigger>
            ...
            <CardFooter>
              <Button type="submit" className="w-full">Define ICP</Button>
            </CardFooter>
          </form>
        </ScrollArea>
      </Card>
